#! /bin/sh 
# top level script for the Sounds demo
# @(#)rundemo.sh	1.4	12/1/92	ERL
...
xtext -t "ABOUT THE SOUNDS DEMO" -Wp 300 510 -F README &

# now we put up a demo control panel; in this example, the top panel (-M) 
# contains README and setup buttons

fbuttons -X 555 -Y 0 -w"Sounds Demo Controls" -i SOUNDS -b 4 -F files.BM -S sounds.BM -M setup.BM 
