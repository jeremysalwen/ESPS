#! /bin/sh
#@(#)get_demo.spc	1.9 1/17/91
# Assume that you are standing in the "entropic" directory
# This only works for the SPARCstation or sun4 without audio
#
# Fix link in esps to point to sparc binaries
rm -f $HOME/entropic/erldemos/esps/bin
ln -s $HOME/entropic/erldemos/esps/bin.sun4 $HOME/entropic/erldemos/esps/bin

rsh masscomp fixowner burton erldemo

# fill out entropic directory
esccs erldemo get ENTROPIC.spa;mv ENTROPIC.spa ENTROPIC; chmod 555 ENTROPIC
esccs erldemo get README.sparc; mv README.sparc README;  chmod 444 README
esccs erldemo get version.spc; mv version.spc version;  chmod 444 version 
mkdir xview;chmod 755 xview;cd xview;cp -r $HOME/entropic/xview.spc/* .
...
esccs erldemo get edemo.ab.spc;mv edemo.ab.spc edemo.about;chmod 444 edemo.about
...
cp -r $HOME/entropic/erldemos/esps/32bin 32bin; chmod 755 32bin;chmod 555 bin/*
cd ..
