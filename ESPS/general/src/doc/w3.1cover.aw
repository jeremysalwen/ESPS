...
H1 SB1 SR1 ST1 CT1 HY1 SE0 SX0 BG0 TF0 TC0 IX0 LA1 PN1 PG1 HF0 SU70 SN"Printer"\
 SC55 WN40,0,12174,7987 TW8500 TH11000 SG0 RM0 RB0 SS0 TB2 DM0 DC"." PF"" ZM2
H2
H3 ON0
WP
AL LI0,0 BR0,"",65535,""
...
CO
EF
TXThis packet contains release notes for all versions of 
TXwaves+
AT IT1
TX since 3.1.    Version 5.0 contains significant new features.  Version 3.1 wa\
s a maintenance release and was shipped to users experiencing specific problems\
 with earlier releases.   Version 3.1 was only available on Sparc and SGI machi\
nes.
AT
WP
AL LI0,0 BR0,"",65535,""
...
CO
EF
TXPlease refer to either the enclosed printed copy of these earlier release not\
es, or see the on-line version in $ESPS_BASE/doc/wrel3.1.doc.
WP
AL LI0,0 BR0,"",65535,""
CO
EF
