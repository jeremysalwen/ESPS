...
AT SZ6
EF
TXThis package contains an update to the installation instructions and release \
notes.   Be sure to read the update to the installation instructions before att\
empting to install the product.     Please read the release notes and pass them\
 on to users of ESPS/
TXxwaves.
AT IT1
WP
