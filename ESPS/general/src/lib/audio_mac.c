...
static char *sccs_id = "@(#)audio_mac.c	1.1 02/06/05 DT";
...
CanRead()
{
	...
	*/
	return(10); /* Just a fake return value. */
}
...
short *buffer;
{
	...
	haveread = rbuf_size/sizeof(short); /* fake a good read */
	return haveread;
}
